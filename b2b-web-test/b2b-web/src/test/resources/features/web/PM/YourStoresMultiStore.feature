@F7394601 @E7121728
Feature: Verify multi store user your stores screen
  ...
  @smoke @regression @pi7.5 @p1 @US7372680
  ...
  @smoke @regression @pi7.5 @p1 @US7713695
  ...
  @smoke @regression @pi7.5 @p1 @US7713695
  Scenario: Verify store name edit popup cancel button functionality
    Then user should see store name with edit icon
    When user click on edit button on your store page
  ...
  Scenario: Verify contact help center link functionality
    ...
    @regression @pi7.6 @p2 @US7372529
    Scenario: validate ui elements of Transfer your points
  ...
  @regression @pi7.6 @p2 @US7372529
  Scenario: validate point transfer from once store to another
    And user click on transfer your points
    And user select one store from to dropdown
    And user enter "10" points in how many points shall we transfer
